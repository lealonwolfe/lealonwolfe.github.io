$(document).ready(function(){
    ...
    function makeCircle(id){
        ...
        circle.id = "#" + id;
        circle.x = Math.random() * maxX + circleRadius; // corrected maXX to maxX
    ...
    function update(){
        ...
        for (var i = 0; i < maxCircles; i++){
            var circle = circles[i]; // corrected circles[j] to circles[i]
    ...
    function moveCircle(circle){
        circle.x += circle.speedX; // corrected assignment issue
    ...
    function bounceCircle(circle){
        ...
        else if (circle.x > boardWidth - circleRadius*2){ // adjust for circle width
            circle.x = boardWidth - circleRadius*2;
            circle.speedX *= -1;
        }
        ...
        else if (circle.y > boardHeight - circleRadius*2){ // adjust for circle height
            circle.y = boardHeight - circleRadius*2;
            circle.speedY *= -1;
        }
    }
